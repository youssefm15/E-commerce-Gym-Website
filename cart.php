	...
	Shopping Cart
		...
		<div class="container">
			...
			<div class="col-md-4">
				<form method="post" action="cart.php?action=add&id=<?php echo $row["id"]; ?>">
					<div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px;" align="center">
						<img src="Admin Dashboard/cartImage/<?php echo $row["image"]; ?>" class="img-responsive" /><br />
			...
			<div class="cart content-wrapper">
				...
				<div class="buttons">
            <input  class="up" style="float: right;" type="submit" value="Place Order" name="placeorder" >
        </div>
                </form>
			</div>
		</div>
